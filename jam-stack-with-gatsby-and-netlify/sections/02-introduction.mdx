...
<Appear>
  <h2 style={{ textAlign: 'center' }}>
    Gatsby rehydrates into a <span className="blue">React</span> app
  </h2>
</Appear>
...
<ul>
  <Appear>
    <li>
      Follows the <a href="https://www.gatsbyjs.org/docs/prpl-pattern/">PRPL</a>{' '}
      pattern
    </li>
...
<ul>
  <Appear>
    <li>
      Start off with a pre-configured development environment and build process
